...
alias dump-system='find ~/.shortcuts ~/termux-backup -maxdepth 2 -not -path "*/.*" -not -path "*/.git*" -type f -exec echo -e "\n--- FILE: {} ---" \; -exec cat {} \; | termux-clipboard-set && echo "📋 System dump copied to clipboard"'
